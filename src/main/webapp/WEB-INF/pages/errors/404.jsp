				...
				<ul class="nav navbar-nav">
						...
						<ul class="dropdown-menu">
							...
							<li>
								...
								<ul class="menu">
									...
									<li><a href="#">
											<div class="pull-left">
												<img src='<c:url value="/public/templates/AdminLTE/dist/img/user4-128x128.jpg"/>'
													class="img-circle" alt="User Image">
											</div>
											<h4>
					...
					<li class="dropdown user user-menu"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"> <img
							src='<c:url value="/public/templates/AdminLTE/dist/img/user2-160x160.jpg"/>' class="user-image"
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header"><img
								src='<c:url value="/public/templates/AdminLTE/dist/img/user2-160x160.jpg"/>' class="img-circle"
								alt="User Image">
		...
		<section class="sidebar">
			...
			<div class="user-panel">
				<div class="pull-left image">
					<img src='<c:url value="/public/templates/AdminLTE/dist/img/user2-160x160.jpg"/>' class="img-circle"
						alt="User Image">
				</div>
				...
				<li class="treeview active"><a href="#"> <i
					...
					<ul class="treeview-menu">
						...
						<li><a href="lockscreen.html"><i class="fa fa-circle-o"></i>
								Lockscreen</a></li>
						<li class="active"><a href="404.html"><i
			...
			<div class="error-page">
				...
				<div class="error-content">
					...
					<p>
						...
						may <a href='<c:url value="/"/>'>return to dashboard</a> or try
